...
//  Description     : It accepts N numbers from user and accept one another number and return index of first occurence
//                    of that number
//                    that number
//  Input           : Int, Int, Int
//  Output          : Int
...
//
//  Input : 7           85  11  3   80  93  11  90      iValue  : 11    Output  : 1
//  Input : 5           20  11  21  22  21              iValue  : 21    Output  : 2
